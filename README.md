...
>**⚠️ Important :** une mise à jour récente de SDL2 sur la version 2.32.8 corrige le problème du crash de la fonction SDL_PollEvent. Lors de l'installation des dépendances, vérifiez que vous possédez bien la version 2.32.8 de SDL2 avant de compiler.
